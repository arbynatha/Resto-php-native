<!-- 
     ...
     halaman input untuk  menambah data tansaksi
-->
<div class="row">
    <div class="col-4">
        ...
        <table class="table table-striped">
            ...
            ?>
                <tr>
                    ...
                    <!-- code mengirim data ke transaksi_detail_update -->
                    <form action="?page=transaksi_detail-update" method="POST">
                        <td width="10%">
                            ...
                            <input style="text-align: center;" class="form-control" name="jumlah_menu" value="<?= $hasil_select_dt->jumlah_menu ?>">
                            <input type="submit" hidden>
                        </td>
                    </form>
                    <!-- kode berakhir disini -->
